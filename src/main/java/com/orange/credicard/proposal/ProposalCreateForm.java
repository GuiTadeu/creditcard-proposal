...
public class ProposalCreateForm {
    ...
    public ProposalCreateForm(@NotBlank String document, @Email @NotBlank String email, @NotNull Address address,
                              @NotNull @Positive BigDecimal salary, @NotNull PersonType personType) {
